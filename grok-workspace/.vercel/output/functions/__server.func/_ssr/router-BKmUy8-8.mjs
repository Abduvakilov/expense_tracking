...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BKmUy8-8.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-lg bg-primary px-2.5 py-1.5 text-xs text-primary-foreground shadow-[var(--shadow-border)]", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-B_lCEI7-.css";
var APP_NAME = "Hisob";
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipProvider, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
						theme: "dark",
						position: "top-center",
						toastOptions: { className: "!bg-card !text-foreground !border-0 !shadow-[var(--shadow-border)] !rounded-xl" }
					})]
				}) }),
...
var $$splitComponentImporter = () => import("./routes-Bwosxd7N.mjs");
